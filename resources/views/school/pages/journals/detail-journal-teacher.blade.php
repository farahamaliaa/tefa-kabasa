                    ...
                    <tbody>
                        @forelse ($attendanceJournals as $attendance)
                            <tr>
                                ...
                                <td class="text-center">
                                    @switch($attendance->status)
                                        @case(AttendanceEnum::SICK)
                                            <span class="mb-1 badge font-medium bg-light-warning text-warning">Sakit</span>
                                        @break

                                        @case(AttendanceEnum::PERMIT)
                                            <span class="mb-1 badge font-medium bg-light-primary text-primary">Izin</span>
                                        @break

                                        @case(AttendanceEnum::ALPHA)
                                            <span class="mb-1 badge font-medium bg-light-danger text-danger">Alfa</span>
                                        @break
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary btn-detail me-1" data-bs-toggle="modal"
                                        data-bs-target="#modal-detail"
                                        data-attendance="{{ $attendance->id }}">Detail</button>
                                </td>
                            </tr>
                            @empty
                            @endforelse
